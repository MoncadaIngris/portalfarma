...
@section('titulo')
Estadisticas de ventas por Proveedor
@stop
@section('contenido')
...
<div id="tabla">
  ...
  <a type="button" href="{{route('grafico.proveedor',['val'=>0])}}" class="btn btn-success">Ver Grafico</a>
...
@else
<div id="grafico">
  <a type="button" class="btn btn-success" href="{{route('grafico.proveedor',['val'=>1])}}">Ver Tabla</a>
<div id="chart">
</div>
</div>
@endif
...
<script>
   var options = {
        ...
        title: {
    text: 'Gráfico de ventas por Proveedor',
    floating: false,
    align: 'center',
    style: {
      color: '#444',
