...
class CreateViewInventarioTable extends Migration
{
    ...
    public function up()
    {
        ...
        IFNULL(nuevo, (SUM(producto__comprados.venta*producto__comprados.cantidad)/sum(producto__comprados.cantidad))) AS venta,
        0 AS vendido
        ...
        left JOIN promocions ON promocions.id_producto = producto__comprados.id_producto
        GROUP BY producto__comprados.id_producto, promocions.nuevo)
        UNION 
