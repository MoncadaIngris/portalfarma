...
E(b,a);b.generateAsync?b.generateAsync(d).then(function(a){q(a,x(c))}):q(b.generate(d),x(c))},filename:"*"+fecha.getDate()+"_"+(fecha.getMonth()+1)+"_"+fecha.getFullYear(),extension:".xlsx",exportOptions:{columns: ':not(.notexport)'},header:!0,footer:!1};r.ext.buttons.pdfHtml5={className:"buttons-pdf buttons-html5",available:function(){return i.FileReader!==o&&(u||i.pdfMake)},text:function(a){return a.i18n("buttons.pdf","PDF")},action:function(a,b,d,c){K(c);var a=b.buttons.exportData(c.exportOptions),f=[];c.header&&f.push(g.map(a.header,function(a){return{text:"string"===typeof a?a:a+"",
...
new Blob([a],{type:"application/pdf"});q(a,x(c))})},title:"*"+fecha.getDate()+"/"+(fecha.getMonth()+1)+"/"+fecha.getFullYear(),filename:"*"+fecha.getDate()+"_"+(fecha.getMonth()+1)+"_"+fecha.getFullYear(),extension:".pdf",exportOptions:{columns: ':not(.notexport)'},orientation:"portrait",pageSize:"A4",header:!0,footer:!1,message:null,customize:null,download:"download"};return r.Buttons});